...
<li class="submenu">
<a class="active" href="javascript:void(0);"><img src="assets/img/icons/time.svg" alt="img"><span>Impact</span> <span class="menu-arrow"></span></a>
<ul>
<li><a class="active" href="Impact.php">Impact List</a></li>
</ul>
</li>
<li class="submenu">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Impact</h5>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        <form class="form-group" action="check_impact.php" method="post" enctype="multipart/form-data">
          <label for="Main_Topic">Impcat Icon</label>
          <input id="iconInput" placeholder="Inter Icon Ass A Fontawesome" class="from-control" name="icon"  type="text">
          <label for="Main_Topic">Impcat Name</label>
          <input class="from-control" name="val_topic"  type="text">
          <label for="Main_Topic">Impact Number</label>
         <input placeholder="Hey Don't Add Plus!" type="text" name="val_text" id="">
      </div>
...
<div class="row">
<div class="col">
<h3 class="page-title">Our Impacts</h3>

<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
<li class="breadcrumb-item active">Our Impact</li>
</ul>
</div>
</div>
<button type="button"  class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#exampleModal">
 <i class="fas fa-plus"></i>&nbsp; Add Impact
</button>
</div>
...
<h4 class="card-title">Impact List</h4>
</div>
<div class="card-body">
...
<?php
$read_val=mysqli_query($conn,"SELECT * FROM impact");
...
<td style='font-size:40px !important;'>$row[icon]</td>
<td>$row[name]</td>
<td style='word-break: break-all;'>$row[number]</td>
<td><a style='color:#fff !important;' href='update_impact.php?val_id=$row[id]' class='btn btn-primary'><i class='fas fa-edit'></i></a>
</td>
                      ...
                      $.ajax({
                          ...
                          success: function(data){
                              Swal.fire(
                                  ...
                                  location.href = "impact.php"; // Reload the page after successful deletion
                              });
                          }
                      });
                  }
