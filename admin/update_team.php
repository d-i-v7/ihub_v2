...
<li class="submenu">
<a  class="active" href="javascript:void(0);"><img src="assets/img/icons/users.svg" alt="img"><span> Our Team</span> <span class="menu-arrow"></span></a>
<ul>
<li><a class="active" href="our_team.php">Our Team List</a></li>
</ul>
</li>
<li class="submenu">
...
$select_team=mysqli_query($conn,"SELECT * FROM our_team WHERE id='$team_id'");

if(mysqli_num_rows($select_team)>0)
{
    while($team_row=mysqli_fetch_assoc($select_team))
    {
        $name=$team_row['name'];
$role=$team_row['role'];
...
?>
        <form class="form-group" action="team_update.php"  method="post" enctype="multipart/form-data">
        <label for="Main_Topic">Member Name</label>
          <input value="<?php  echo $name; ?>" class="from-control" name="name"  type="text">
          <label for="Main_Topic">Member Role</label>
          <input value="<?php  echo $role; ?>" class="from-control" name="role"  type="text">
          <label for="Main_Topic">Facebook Link</label>
          <input value="<?php  echo $link_1; ?>" class="from-control" name="link_1"  type="text">
          <label for="Main_Topic">Instagram Link</label>
          <input value="<?php  echo $link_2; ?>" class="from-control" name="link_2"  type="text">
           <div class="col-lg-12">
      ...
      <div class="modal-footer">
        <a  class="btn btn-secondary" href="our_team.php" >Close</a>
        ...
        img.onload = function () {
          if (img.width < 400 || img.height < 400) {
            ...
            Swal.fire({
              ...
              text: 'Please select an image with dimensions greater than or equal to 400px width and 400px height.',
            });
