...
<div class="modal-body">
      ...
      <div class="modal-footer">
        <a  class="btn btn-secondary" href="profile.php" >Close</a>
...
<!-- CONTROLL OF IMAGE UPLOADER -->
  ...
  function handleFileSelect(event) {
    ...
    if (file) {
      ...
      if (file.type === 'image/JPG'|| file.type === 'image/webp' || file.type ==='image/svg'||file.type === 'image/jpeg'||file.type === 'image/png') {
        ...
        img.onload = function () {
          if (img.width > 600 || img.height > 600) {
            ...
            Swal.fire({
              ...
              text: 'Please select an image with dimensions Les than or equal to 500px width and 500px height.',
            });
        ...
        Swal.fire({
          ...
          text: 'Please select a Png Or Svg Or Webp or png or jpg or jpeg Image!.',
        });
