  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-group" action="check_val.php" method="post" enctype="multipart/form-data">
          <label for="Main_Topic">Value Topic</label>
          <input class="from-control" name="val_topic"  type="text">
          <label for="Main_Topic">Value Description</label>
          <textarea  class="form-control" name="val_text" id="" cols="30" rows="10"></textarea>
      </div>
...
<div class="row">
<div class="col">
<h3 class="page-title">Our Values</h3>
...
<h4 class="card-title">Values List</h4>
</div>
<div class="card-body">
...
<td>$row[val_topic]</td>
<td style='word-break: break-all;'>$row[val_text]</td>
<td><a style='color:#fff !important;' href='update_val.php?val_id=$row[id]' class='btn btn-primary'><i class='fas fa-edit'></i></a>
</td>
                      ...
                      $.ajax({
                          ...
                          success: function(data){
                              Swal.fire(
                                  ...
                                  location.href = "our_val.php"; // Reload the page after successful deletion
                              });
                          }
                      });
                  }
