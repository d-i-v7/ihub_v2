...
<li><a class="active" href="about_img.php">About Us Image</a></li>
...
<ul>
<li><a  href="purchaselist.html">Our Services List</a></li>
</ul>
</li>
<li class="submenu">
...
<div class="modal-body">
        ...
        <form action="about_image_update.php"  method="post" enctype="multipart/form-data">
          <div class="col-lg-12">
...
<!-- CONTROLL OF IMAGE UPLOADER -->
  ...
  function handleFileSelect(event) {
    ...
    if (file) {
      ...
      if (file.type === 'image/png'|| file.type === 'image/webp' || file.type ==='image/svg') {
        ...
        Swal.fire({
          ...
          text: 'Please select a Png Or Svg Or Webp Image!.',
        });
