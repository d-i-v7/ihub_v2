...
<div class="card-header"><h4>Footer Socail Links</h4></div>
<div class="card-body">
<div class="row ">
...
if(mysqli_num_rows($read_link)>0){
...
<input value="<?php echo"$row_link[fb_link]"; ?>" name="fb_link" type="text" placeholder="Enter Link">
</div>
</div>
<div class="col-lg-12 col-sm-12 col-12">
<div class="form-group">
<label>Instagram<span class="manitory">*</span></label>
<input value="<?php echo"$row_link[in_link]"; ?>"  name="in_link" type="text" placeholder="Enter Link">
</div>
</div>
<div class="col-lg-12 col-sm-12">
<div class="form-group">
<label>Twitter<span class="manitory">*</span> </label>
<input value="<?php echo"$row_link[tw_link]"; ?>"  name="tw_link" type="text" placeholder="Enter Link">
<?php      }
} ?>
</div>
</div>
...
<div class="row">
<div class="col-lg-12">
<button name="submit" class="btn btn-submit me-2">Save</button>
...
<h4 class="card-title">Image Slider List</h4>
</div>
<div class="card-body">
...
<?php
$read_img=mysqli_query($conn,"SELECT * FROM logo");
if(mysqli_num_rows($read_img)>0)
{

    while($row=mysqli_fetch_assoc($read_img)){
echo "<style>
.no-date{
display:none !important;
}
</style><tr><td>$row[id]</td>
<td><img style='border:1px solid #eee; border-radius:5px ;' width='120px' height='120px' src='$row[image]' alt='No Image' ></td>
<td><a style='color:#fff !important;' href='update_logo.php?img_id=$row[id]' class='btn btn-primary'><i class='fas fa-edit'></i></a></tr>
...
<div class="row">
<div class="col">
<h3 class="page-title">Logo Slider</h3>
...
<div class="card">
<div class="card-header">
<h4 class="card-title">Logo Slider List</h4>
</div>
<div class="card-body">
<div class="table-responsive">
<table class="table mb-0">
                      ...
                      $.ajax({
                          ...
                          success: function(data){
                              Swal.fire(
                                  ...
                                  location.href = "setting.php"; // Reload the page after successful deletion
                              });
                          }
                      });
                  }
