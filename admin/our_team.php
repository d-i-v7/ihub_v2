  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-group" action="check_team.php" method="post" enctype="multipart/form-data">
          <label for="Main_Topic">Member Name</label>
          <input class="from-control" name="name"  type="text">
          <label for="Main_Topic">Member Role</label>
          <input class="from-control" name="role"  type="text">
          <label for="Main_Topic">Facebook Link</label>
          <input class="from-control" name="link_1"  type="text">
          <label for="Main_Topic">Instagram Link</label>
          <input class="from-control" name="link_2"  type="text">
         <div class="col-lg-12">
...
if(mysqli_num_rows($read_team)>0)
{
    ...
    while($row=mysqli_fetch_assoc($read_team)){
echo "<style>
.no-date{
...
<td>$row[role]</td>
<td>
  <a class='btn btn-info update-btn'  href='update_team.php?team_id=$row[id]'><i class='fas fa-edit'></i></a>
</td>
                      ...
                      $.ajax({
                          ...
                          success: function(data){
                              Swal.fire(
                                  ...
                                  location.href = "our_team.php"; // Reload the page after successful deletion
                              });
                          }
                      });
                  }
