...
<body>
    <div class="contan">
    <div class="error">
       <h1 class="h1"><i class="fa-solid fa-triangle-exclamation"></i></h1>
            <h2 class="h2"><strong>OOPS!</strong></h2><br>
            <p class="p"><?php  echo $_SESSION['error']  ;  ?></p><br>
            <form action="" method="post">
           <a href="<?php error_reporting(false); echo $_SESSION['link'] ; ?>" id="canel">Ok</a>
            </form>
        </div>
    </div>
...
background-color: rgb(229, 55, 113);
border: none;
color: white;
padding:5px;
width: 55px;
