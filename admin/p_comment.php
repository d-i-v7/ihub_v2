...
<ul>
<li><a class="active" href="p_comment.php">Padding Coments</a></li>
...
<div class="row">
<div class="col">
<h3 class="page-title">Padding Comments</h3>

<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
<li class="breadcrumb-item active">Padding Comments</li>
</ul>
</div>
</div>
...
<h4 class="card-title">Padding Coments</h4>
</div>
<div class="card-body">
...
<?php
$read_p_coment=mysqli_query($conn,"SELECT * FROM p_coment");
if(mysqli_num_rows($read_p_coment)>0)
{

    while($row=mysqli_fetch_assoc($read_p_coment)){
echo "<style>
.no-date{
...
<td>
<form action='insert_active_coment.php' method='POST' enctype='multipart/form-data'>
<input value='$row[image]' name='image' hidden type='text' class='text'>
<input value='$row[name]' name='name' hidden type='text' class='file'>
<input value='$row[coment]' name='coment' hidden type='text' class='file'>
<button name='puplic' type='submit' class='btn btn-success ' ><i class='fa fa-solid fa-eye'></i></button>
                      ...
                      $.ajax({
                          ...
                          success: function(data){
                              Swal.fire(
                                  ...
                                  location.href = "p_comment.php"; // Reload the page after successful deletion
                              });
                          }
                      });
                  }
