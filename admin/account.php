...
?>
        <form class="form-group" action="account_s.php"  method="post" enctype="multipart/form-data">
        <p>To Change Your Email Or Your User Name Or Your Password You Must Enter Your Old Password </p>
        <label for="Main_Topic">Old Password</label>
          <input placeholder="First Enter Your Old Password Here!" value="" class="from-control" name="old_password"  type="text">
        <label for="Main_Topic">New User Name</label>
          <input placeholder="Inter New User Name Here" value="<?php  echo $user_name ; ?>" class="from-control" name="user_name"  type="text">
        <label placeholder="Inter New User Name Here" for="Main_Topic">New Email</label>
          <input value="<?php echo $email;  ?>" class="from-control" name="email"  type="text">
        <label for="Main_Topic">New Password</label>
          <input placeholder="Inter Your New Password Here" class="from-control" name="new_password"  type="text">
