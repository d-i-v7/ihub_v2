...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Hide the greeting after 5 seconds with a fade-out animation
    setTimeout(function () {
      greeting.style.animation = "fadeOut 2s ease-in-out forwards";
...
//     // Check if the user's device has a dark color scheme
//     var darkModeMediaQuery = window.matchMedia('(prefers-color-scheme: dark)');
    
//     // Apply dark mode styles if the user's device is in dark mode
//     if (darkModeMediaQuery.matches) {
//       bgContainer.classList.add('dark-mode');
//       greeting.classList.add('dark-mode');
//     }

//     // Add event listener to toggle dark mode when the color scheme changes
...
//         greeting.classList.remove('dark-mode');
//       }
//     });
//   });
