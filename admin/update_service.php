...
<div class="modal-body">
    ...
    $_SESSION['serv_id']=$serv_id;
$select_serv=mysqli_query($conn,"SELECT * FROM our_ser WHERE id='$serv_id'");

if(mysqli_num_rows($select_serv)>0)
{
    while($serv_row=mysqli_fetch_assoc($select_serv))
    {
        $serv_topic=$serv_row['topic'];
$serv_text=$serv_row['text'];


?>
        <form class="form-group" action="serv_update.php"  method="post" enctype="multipart/form-data">
        <label for="Main_Topic">service Topic</label>
          <input value="<?php echo $serv_topic ; ?>" class="from-control" name="topic"  type="text">
          <label for="Main_Topic">service Description</label>
          <textarea  class="form-control" name="text" id="" cols="30" rows="10"><?php echo $serv_text ; ?></textarea>
          <div class="col-lg-12">
      ...
      <div class="modal-footer">
        <a  class="btn btn-secondary" href="our_ser.php" >Close</a>
